$(document).ready(function($) {
    ...
    $(".avatars").click(function(){
        ...
        $("body").append($('<audio id="bg_music" autoplay loop><source src="assets/music/windstop.mp3" type="audio/mp3"></audio>'));
    });
    ...
    if(localStorage.getItem("user")!=null){
        ...
        $(".password").hide();
        $('#container').removeClass("blurpage");
        $("body").append($('<audio autoplay loop><source src="assets/music/windstop.mp3" type="audio/mp3"></audio>'));
    }
